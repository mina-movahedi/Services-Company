...
var css_248z$c = ".c1wupbe700-canary37{contain:strict;contain:size layout style paint;padding:0 8px;border-right:1px solid var(--border-color);border-bottom:1px solid var(--border-color);background-color:inherit;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.cd0kgiy700-canary37{position:-webkit-sticky;position:sticky;z-index:1}.c1730fa4700-canary37{box-shadow:2px 0 5px -2px hsla(0,0%,53.3%,.3)}.c9dpaye700-canary37{box-shadow:inset 0 0 0 2px var(--selection-color)}";
styleInject(css_248z$c);

const cell = "c1wupbe700-canary37";
const cellClassname = `rdg-cell ${cell}`;
const cellFrozen = "cd0kgiy700-canary37";
const cellFrozenClassname = `rdg-cell-frozen ${cellFrozen}`;
const cellFrozenLast = "c1730fa4700-canary37";
const cellFrozenLastClassname = `rdg-cell-frozen-last ${cellFrozenLast}`;
const cellSelected = "c9dpaye700-canary37";
const cellSelectedClassname = `rdg-cell-selected ${cellSelected}`;

var css_248z$b = ".r104f42s700-canary37{--color:#000;--border-color:#ddd;--summary-border-color:#aaa;--background-color:hsl(0deg 0% 100%);--header-background-color:hsl(0deg 0% 97.5%);--row-hover-background-color:hsl(0deg 0% 96%);--row-selected-background-color:hsl(207deg 76% 92%);--row-selected-hover-background-color:hsl(207deg 76% 88%);--checkbox-color:hsl(207deg 100% 29%);--checkbox-focus-color:hsl(207deg 100% 69%);--checkbox-disabled-border-color:#ccc;--checkbox-disabled-background-color:#ddd;--selection-color:#66afe9;--font-size:14px;contain:strict;contain:size layout style paint;content-visibility:auto;height:350px;border:1px solid var(--border-color);box-sizing:border-box;overflow:auto;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;background-color:var(--background-color);color:var(--color);font-size:var(--font-size)}@supports not (contain:strict){.r104f42s700-canary37{position:relative;z-index:0}}.r104f42s700-canary37 *,.r104f42s700-canary37 :after,.r104f42s700-canary37 :before{box-sizing:inherit}.r104f42s700-canary37.rdg-dark{--color:#ddd;--border-color:#444;--summary-border-color:#555;--background-color:hsl(0deg 0% 13%);--header-background-color:hsl(0deg 0% 10.5%);--row-hover-background-color:hsl(0deg 0% 9%);--row-selected-background-color:hsl(207deg 76% 42%);--row-selected-hover-background-color:hsl(207deg 76% 38%);--checkbox-color:hsl(207deg 100% 79%);--checkbox-focus-color:hsl(207deg 100% 89%);--checkbox-disabled-border-color:#000;--checkbox-disabled-background-color:#333}@media (prefers-color-scheme:dark){.r104f42s700-canary37:not(.rdg-light){--color:#ddd;--border-color:#444;--summary-border-color:#555;--background-color:hsl(0deg 0% 13%);--header-background-color:hsl(0deg 0% 10.5%);--row-hover-background-color:hsl(0deg 0% 9%);--row-selected-background-color:hsl(207deg 76% 42%);--row-selected-hover-background-color:hsl(207deg 76% 38%);--checkbox-color:hsl(207deg 100% 79%);--checkbox-focus-color:hsl(207deg 100% 89%);--checkbox-disabled-border-color:#000;--checkbox-disabled-background-color:#333}}.f7ly7s700-canary37{position:-webkit-sticky;position:sticky;top:0;left:0;height:0;width:0;outline:0}.vc4f4zb700-canary37.r1otpg64700-canary37{cursor:move}";
styleInject(css_248z$b);

const root = "r104f42s700-canary37";
const rootClassname = `rdg ${root}`;
const focusSink = "f7ly7s700-canary37";
const focusSinkClassname = `rdg-focus-sink ${focusSink}`;
const viewportDragging = "vc4f4zb700-canary37";
const viewportDraggingClassname = `rdg-viewport-dragging ${viewportDragging}`;

var css_248z$a = ".g1cvx5us700-canary37:not(.rel5gk2700-canary37){background-color:var(--header-background-color)}.g1cvx5us700-canary37>.c1wupbe700-canary37:not(:last-child):not(.c1730fa4700-canary37){border-right:none}.g1j2w62i700-canary37:after{content:\"\";position:absolute;top:0;right:0;bottom:0;left:0;box-shadow:inset 0 0 0 2px var(--selection-color);pointer-events:none;z-index:2}.g1j2w62i700-canary37>.c1wupbe700-canary37:first-child{box-shadow:inset 2px 0 0 0 var(--selection-color)}";
styleInject(css_248z$a);

const groupRow = "g1cvx5us700-canary37";
const groupRowClassname = `rdg-group-row ${groupRow}`;
const groupRowSelected = "g1j2w62i700-canary37";
const groupRowSelectedClassname = `rdg-group-row-selected ${groupRowSelected}`;

var css_248z$9 = ".h1fquj5h700-canary37{contain:strict;contain:size layout style paint;display:grid;grid-template-columns:var(--template-columns);width:var(--row-width);position:-webkit-sticky;position:sticky;background-color:var(--header-background-color);font-weight:700;z-index:3}.h19m9p7h700-canary37{grid-template-rows:var(--header-row-height);height:var(--header-row-height);line-height:var(--header-row-height);top:0;touch-action:none}.fkdzs1h700-canary37{grid-template-rows:var(--filter-row-height);height:var(--filter-row-height);line-height:var(--filter-row-height);top:var(--header-row-height)}";
styleInject(css_248z$9);

const headerRowAndFilterRow = "h1fquj5h700-canary37";
const headerRow = "h19m9p7h700-canary37";
const headerRowClassname = `rdg-header-row ${headerRowAndFilterRow} ${headerRow}`;
const filterRow = "fkdzs1h700-canary37";
const filterRowClassname = `rdg-filter-row ${headerRowAndFilterRow} ${filterRow}`;

var css_248z$8 = ".r1otpg64700-canary37{contain:strict;contain:size layout style paint;display:grid;grid-template-rows:var(--row-height);grid-template-columns:var(--template-columns);position:absolute;left:0;width:var(--row-width);height:var(--row-height);line-height:var(--row-height);background-color:var(--background-color)}.r1otpg64700-canary37:hover{background-color:var(--row-hover-background-color)}.rel5gk2700-canary37{background-color:var(--row-selected-background-color)}.rel5gk2700-canary37:hover{background-color:var(--row-selected-hover-background-color)}.s1qymf1z700-canary37{position:-webkit-sticky;position:sticky;z-index:3;grid-template-rows:var(--summary-row-height);height:var(--summary-row-height);line-height:var(--summary-row-height)}.s1qymf1z700-canary37>.c1wupbe700-canary37{border-top:2px solid var(--summary-border-color)}";
styleInject(css_248z$8);

const row = "r1otpg64700-canary37";
const rowClassname = `rdg-row ${row}`;
const rowSelected = "rel5gk2700-canary37";
const rowSelectedClassname = `rdg-row-selected ${rowSelected}`;
const summaryRow = "s1qymf1z700-canary37";
...
var css_248z$7 = ".c1w6d5eo700-canary37{cursor:pointer;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;position:absolute;top:0;right:0;bottom:0;left:0;margin-right:1px}.c1h7iz8d700-canary37{all:unset;width:0;margin:0}.cc79ydj700-canary37{content:\"\";width:20px;height:20px;border:2px solid var(--border-color);background-color:var(--background-color)}.c1h7iz8d700-canary37:checked+.cc79ydj700-canary37{background-color:var(--checkbox-color);box-shadow:inset 0 0 0 4px var(--background-color)}.c1h7iz8d700-canary37:focus+.cc79ydj700-canary37{border-color:var(--checkbox-focus-color)}.c1e5jt0b700-canary37{cursor:default}.c1e5jt0b700-canary37 .cc79ydj700-canary37{border-color:var(--checkbox-disabled-border-color);background-color:var(--checkbox-disabled-background-color)}";
styleInject(css_248z$7);

const checkboxLabel = "c1w6d5eo700-canary37";
const checkboxLabelClassname = `rdg-checkbox-label ${checkboxLabel}`;
const checkboxInput = "c1h7iz8d700-canary37";
const checkboxInputClassname = `rdg-checkbox-input ${checkboxInput}`;
const checkbox = "cc79ydj700-canary37";
const checkboxClassname = `rdg-checkbox ${checkbox}`;
const checkboxLabelDisabled = "c1e5jt0b700-canary37";
...
var css_248z$6 = ".gch972y700-canary37{outline:none}.cz2qf0d700-canary37{margin-left:4px;stroke:currentColor;stroke-width:1.5px;fill:transparent;vertical-align:middle}.cz2qf0d700-canary37>path{-webkit-transition:d .1s;transition:d .1s}";
styleInject(css_248z$6);

const groupCellContent = "gch972y700-canary37";
const groupCellContentClassname = `rdg-group-cell-content ${groupCellContent}`;
const caret = "cz2qf0d700-canary37";
...
var css_248z$5 = ".h13yq3r8700-canary37{cursor:pointer;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex}.ht6rdyl700-canary37{-webkit-box-flex:1;-webkit-flex-grow:1;-ms-flex-positive:1;flex-grow:1;overflow:hidden;text-overflow:ellipsis}";
styleInject(css_248z$5);

const headerSortCell = "h13yq3r8700-canary37";
const headerSortCellClassname = `rdg-header-sort-cell ${headerSortCell}`;
const headerSortName = "ht6rdyl700-canary37";
...
var css_248z$4 = ".celq7o9700-canary37:after{content:\"\";cursor:col-resize;position:absolute;top:0;right:0;bottom:0;width:10px}";
styleInject(css_248z$4);

const cellResizable = "celq7o9700-canary37";
...
var css_248z$3 = ".c1bmg16t700-canary37,.ccpfvsn700-canary37{background-color:#ccf}.c1bmg16t700-canary37.ccpfvsn700-canary37{background-color:#99f}.c12t67zz700-canary37{cursor:move;position:absolute;right:0;bottom:0;width:8px;height:8px;background-color:var(--selection-color)}.c12t67zz700-canary37:hover{width:16px;height:16px;border:2px solid var(--selection-color);background-color:var(--background-color)}";
styleInject(css_248z$3);

const cellCopied = "ccpfvsn700-canary37";
const cellCopiedClassname = `rdg-cell-copied ${cellCopied}`;
const cellDraggedOver = "c1bmg16t700-canary37";
const cellDraggedOverClassname = `rdg-cell-dragged-over ${cellDraggedOver}`;
const cellDragHandle = "c12t67zz700-canary37";
...
var css_248z$2 = ".e1d24x2700-canary37{display:contents}";
styleInject(css_248z$2);

const editorContainer = "e1d24x2700-canary37";
...
var css_248z$1 = ".c1tngyp1700-canary37{padding:0}";
styleInject(css_248z$1);

const cellEditing = "c1tngyp1700-canary37";
...
var css_248z = ".t16y9g8l700-canary37{-webkit-appearance:none;-moz-appearance:none;appearance:none;box-sizing:border-box;width:100%;height:100%;padding:0 6px;border:2px solid #ccc;vertical-align:top;color:var(--color);background-color:var(--background-color);font-family:inherit;font-size:var(--font-size)}.t16y9g8l700-canary37:focus{border-color:var(--selection-color);outline:none}.t16y9g8l700-canary37::-webkit-input-placeholder{color:#999;opacity:1}.t16y9g8l700-canary37::-moz-placeholder{color:#999;opacity:1}.t16y9g8l700-canary37:-ms-input-placeholder{color:#999;opacity:1}.t16y9g8l700-canary37::placeholder{color:#999;opacity:1}";
styleInject(css_248z);

const textEditor = "t16y9g8l700-canary37";
